...
export const FIELD_VALUE_KEYS: Record<string, readonly string[]> = {
  ...
  channelMonitorRefreshIntervalSeconds: ['channelMonitorRefreshIntervalSeconds'],
  channelMonitorDatabasePath: ['channelMonitorDatabasePath'],
  channelMonitorAuthIndexes: ['channelMonitorAuthIndexes'],
  channelMonitorProviders: ['channelMonitorProviders'],
  channelMonitorModels: ['channelMonitorModels'],
  channelMonitorIgnoredErrorCategories: ['channelMonitorIgnoredErrorCategories'],
  channelMonitorMinimumSample: ['channelMonitorMinimumSample'],
  channelMonitorWarningErrorRate: ['channelMonitorWarningErrorRate'],
  channelMonitorCriticalErrorRate: ['channelMonitorCriticalErrorRate'],
  channelMonitorTargetTtftMs: ['channelMonitorTargetTtftMs'],
  channelMonitorCriticalTtftMs: ['channelMonitorCriticalTtftMs'],
  channelMonitorErrorWeight: ['channelMonitorErrorWeight'],
  channelMonitorTtftWeight: ['channelMonitorTtftWeight'],
  channelMonitorCacheWeight: ['channelMonitorCacheWeight'],
  // ── quota ─────────────────────────────────────────────────────────────────
