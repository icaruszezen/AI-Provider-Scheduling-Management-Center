...
export const CONFIG_FIELD_SEARCH_INDEX: ConfigFieldSearchEntry[] = [
  ...
  {
    fieldId: 'channelMonitorEnabled',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_enabled'),
    hintKey: L('sections.logging.channel_monitor_enabled_hint'),
    yamlKeys: ['channel-monitor', 'enabled'],
    keywords: ['channel monitor', 'health'],
  },
  {
    fieldId: 'channelMonitorRefreshIntervalSeconds',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_refresh'),
    hintKey: L('sections.logging.channel_monitor_refresh_hint'),
    yamlKeys: ['channel-monitor', 'refresh-interval-seconds'],
  },
  {
    fieldId: 'channelMonitorDatabasePath',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_database_path'),
    hintKey: L('sections.logging.channel_monitor_database_path_hint'),
    yamlKeys: ['channel-monitor', 'database-path'],
  },
  {
    fieldId: 'channelMonitorAuthIndexes',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_auth_indexes'),
    hintKey: L('sections.logging.channel_monitor_auth_indexes_hint'),
    yamlKeys: ['channel-monitor', 'auth-indexes'],
  },
  {
    fieldId: 'channelMonitorProviders',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_providers'),
    hintKey: L('sections.logging.channel_monitor_providers_hint'),
    yamlKeys: ['channel-monitor', 'providers'],
  },
  {
    fieldId: 'channelMonitorModels',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_models'),
    hintKey: L('sections.logging.channel_monitor_models_hint'),
    yamlKeys: ['channel-monitor', 'models'],
  },
  {
    fieldId: 'channelMonitorIgnoredErrorCategories',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_ignored'),
    hintKey: L('sections.logging.channel_monitor_ignored_hint'),
    yamlKeys: ['channel-monitor', 'ignored-error-categories'],
  },
  {
    fieldId: 'channelMonitorMinimumSample',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_minimum_sample'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'minimum-sample'],
  },
  {
    fieldId: 'channelMonitorWarningErrorRate',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_warning_error_rate'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'warning-error-rate'],
  },
  {
    fieldId: 'channelMonitorCriticalErrorRate',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_critical_error_rate'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'critical-error-rate'],
  },
  {
    fieldId: 'channelMonitorTargetTtftMs',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_target_ttft'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'target-ttft-ms'],
  },
  {
    fieldId: 'channelMonitorCriticalTtftMs',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_critical_ttft'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'critical-ttft-ms'],
  },
  {
    fieldId: 'channelMonitorErrorWeight',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_error_weight'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'error-weight'],
  },
  {
    fieldId: 'channelMonitorTtftWeight',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_ttft_weight'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'ttft-weight'],
  },
  {
    fieldId: 'channelMonitorCacheWeight',
    sectionId: 'logging',
    labelKey: L('sections.logging.channel_monitor_cache_weight'),
    yamlKeys: ['channel-monitor', 'health-thresholds', 'cache-weight'],
  },
  // ── quota ─────────────────────────────────────────────────────────────────
  {
