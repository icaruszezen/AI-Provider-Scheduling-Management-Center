# AI Provider Scheduling Management Center

A single-file Web UI (React + TypeScript) for operating and troubleshooting **AI Provider Scheduling** via its **Management API** (config, credentials, and logs).

[中文文档](README_CN.md)

**Main Project**: https://github.com/icaruszezen/AIProviderScheduling  
...
### Option A: Use the Web UI bundled in AI Provider Scheduling (recommended)

1. Start your AI Provider Scheduling service.
...
Open `http://localhost:5173`, then connect to your AI Provider Scheduling backend instance.
...
- For AI Provider Scheduling bundling, the release workflow renames it to `management.html`.
...
Check the AI Provider Scheduling server documentation/config comments for the full authentication rules, server-side limits, and edge cases.
